  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 style={{color:"hotpink"}} className={styles.sectionHeadText}>Contact.</h3>
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:b.jogendra2003@gmail.com" target="_blank" className="blue-text-gradient">b.jogendra@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=8897794453&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +91 8897794453
            </a>
          </article>
        </div>
